...
## Contributions Week 3 - [15.04.26] to [20.04.26]
...
|   | [18.05.26]   | [https://github.com/AWHerzog/sopra-fs26-group-28-client/commit/cf37ddf2bd7aff1d12e06a857dd14613ba1655a0] | [Added English as translation option 5 min] | [You can switch back to the original language after translating] |
...
|                    | [date]   | [Link to Commit 2] | [Brief description of the task] | [Why this contribution is relevant] |
| **[luizcodes02]** | [17.05.26]   | [[Link to Commit 1](https://github.com/AWHerzog/sopra-fs26-group-28-client/commit/685ab4c9d24d7d52441a203a561c71aeadf905e8)] | [Filter incoming friend requests to only show PENDING ones; show real backend error message on failed friend request, 0.5h] | [Prevents already handled requests from cluttering the inbox and surfaces actionable backend errors to the user.] |
|                    | [19.05.26]   | [[Link to Commit 2](https://github.com/AWHerzog/sopra-fs26-group-28-client/commit/9fc6b1f97afa73319622e6acf21e13dc627729c5)] | [Add friend game invite system: host can invite online friends directly from the lobby; invited players see a pending invite card on the dashboard and can accept or decline, 5.5h] | [Removes need to share game codes manually, making it easier to play with friends.] |
